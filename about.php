...
<head>
	...
	<title>Waltair Cabs | About us</title>
			...
			<div class="wrap">
				...
				<nav role="navigation" class="main-nav">
					<ul>
						...
						<li class="active"><a href="about" title="">About Us</a></li>
		...
		<div class="wrap">
			<div class="row">
				...
				<div class="content three-fourth textongrey">
					<h2>Our story</h2>
					<p class="lead" style="text-align:justify;">Waltair cabs can guarantee the best convenience to all Customers. Waltair Cabs will do our very best for your comfortable and pleasant ride. You can get a special care by taxi drivers before, during, and after their ride. Whether go, so give us a try!Today Waltair Cabs offers its truly world-class services in entire Visakhapatnam.Our constant endeavour will be to raise the standards for everyone who comes intocontact with Waltair Cabs.For those who avail our service, Waltair Cabs offers a cab service that emulates the best taxi service norms across the city..</p> 
					<p style="text-align:justify;">Safety and comfortable travel is the promise of Waltair Cabs.Our professional service providers are giving the ultimate service to satisfy our customers.Well maintained vehicles and licensed drivers are the strong part of Wlatair Cabs. The online Waltair Cab booking helps the custmers to get a transparent service from Waltair Cabs.</p> 
					...
					<h3>Our vision</h3>
					<p style="text-align:justify;">To be the most dependable, affordable, and one-of- its-kind cab service provider across the length and breadth of the Vizag city.</p>
				</div>
				<!--- //Content -->
				...
				<aside class="one-fourth sidebar right offset">
					...
					<div class="widget">
						...
						<div class="textwidget">
							...
							<h5>Pleasant</h5>
							<p style="text-align:justify;">We have clear and transparent pricing listed online. Never haggle with drivers again on payments and be confident and assured of what you are being charged for</p>
						</div>
					</div>
					<!-- //Widget -->
			...
			<div class="wrap">
				<div class="row">
					...
					<div class="one-third wow fadeIn">
						...
						<h3>Fixed rates</h3>
						<p>MINI Rs 9 For 1 KM Hourly Package Rs 140 /Hr for 10 KM.10% discounts for our constant clients</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn" data-wow-delay=".2s">
						...
						<p>The GPS(Global Positiong system) will enable our cabs to provide timely service by giving an accurate estimated time of arrival (ETA).</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn" data-wow-delay=".4s">
						...
						<p> See all expenses involved in your trip upfront before booking your cab. Economical and transparent pricing is our assurance to you.</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn" data-wow-delay=".4s">
						...
						<!--<p>Travel some distance between one place to another place of work on a regular basis. Journey across town. Early morning flight. Late night journey's. Wherever you’re headed, count on WC for a ride—no reservations required.</p>-->
						<p>
					...
					<div class="one-third wow fadeIn" data-wow-delay=".4s">
						...
						<p>Our cars are audited for cleanliness, safety and comfort. Our drivers are well trained and reliable. Sit back and enjoy the WC experience!</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn" data-wow-delay=".2s">
						...
						<p>Safety and comfortable travel is the promise of Waltair cabs. Our professional service providers are giving the ultimate service to satisfy our customers..</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn">
						...
						<p>You may be charged a cancellation fee if a booking request is cancelled 5 minutes or later after driver accepts the booking request or if driver has already arrived at the pickup location.</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn" data-wow-delay=".3s">
						...
						<p>Travel some distance between one place to another place of work on a regular basis. Journey across town. Wherever you’re headed,count on WC for a ride—no reservations required.</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn">
						...
						<p>To exceed customer expectations by providing high-quality and reliable services at every level. To serve you better, we are constantly innovating and upgrading our service to offer you.</p>
					</div>
					<!-- //Item -->
